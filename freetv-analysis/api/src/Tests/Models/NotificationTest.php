...
class NotificationTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->config->test['request']['server'] = array(
            'REQUEST_URI' => '/notification/clientId/1',
            'REQUEST_METHOD' => 'POST',
            'ENVIRONMENT' => 'test',
        );
    ...
    public function testRetrieval()
    {
        ...
        $this->assertTrue($model->name === "All Emails");
        $this->assertTrue($model->createdBy === "7212");
    ...
    public function testCreationUpdationAndDeletion()
    {
        ...
        $data = array(
            'name' => 'testing notification Updated',
        );
        ...
        $this->assertTrue($data['name'] === 'testing notification Updated');
