...
class CommentTest extends \PHPUnit_Framework_TestCase 
{
    ...
    public function setUp()
    {
        ...
        $this->config->test['request']['server'] = array(
            'REQUEST_URI' => '/comment/clientId/1',
            'REQUEST_METHOD' => 'POST',
            'ENVIRONMENT' => 'test',
        );
    ...
    public function testRetrieval()
    {
        ...
        $this->assertTrue($model->comment === "This is a comment + Updated");
    ...
    public function testCreationUpdationAndDeletion()
    {
        ...
        $data = array(
            'comment' => 'testing comments + Updated',
        );
        ...
        $this->assertTrue($data['comment'] === 'testing comments + Updated');
