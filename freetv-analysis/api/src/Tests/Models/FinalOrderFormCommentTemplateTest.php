...
class FinalOrderFormCommentTemplateTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testRetrieval()
    {
        ...
        $this->assertTrue($model->name === "Test");
        $this->assertTrue($model->comment === "this is a comment");
